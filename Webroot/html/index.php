...
class cheesey_api
{
    ...
    private function checkHeaders($decryptedInput)
    {
        ...
        if(!($headers['57ACF958FDD44F91'] == "MkJBQTQ5RTE3Qzk2MEY2NA=="/*x64*/ || $headers['57ACF958FDD44F91'] == "DebugString=="/*x86*/) && !$this->isAdmin())
        {
            $returnMe = false;
        }
    ...
    private function checkNoodles($decryptedInput)
    {
        ...
        // File hash challenge
        if(!($decryptedInput->noodles == "2BAA49E17C960F64"/*x64*/ || $decryptedInput->noodles == "0000A16410818151"/*x86*/) && !$this->isAdmin())
        {
            $returnMe = false;
        }
