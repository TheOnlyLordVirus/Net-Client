...
namespace t9_cheat
{
    ...
    class Weapons
    {
        ...
        {
            get { return memory.ReadPointer(weaponBase + (0x40 * index)); }
            set { memory.WritePointer(weaponBase + (0x40 * index), value); }
        }
    }
    class gclients
    {
        ...
        public void initialize(int clientNum)
        {
            ...
            clientBase = (memory.ReadPointer(baseAddr + (Int64)Addresses.gclient_a) + (clientNum * 0xB970));
        }

        public enum Addresses
        {
            gclient_a = 0x10A5F758,
            ...
            m_weapTime = 0xE48, //update me
            m_thirdperson = 0x1664,
