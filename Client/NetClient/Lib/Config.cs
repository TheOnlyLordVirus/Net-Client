...
namespace FileConfig
{
    ...
    class ProjectConfig
    {
        ...
        public string getConfigName(int index)
        {
            ...
            MessageBox.Show("Error: Settings index was out of the bounds of settings array.", "Error!");
            return string.Empty;
        }
        ...
        public string getConfigValue(string index)
        {
            ...
            MessageBox.Show("Error: Setting does not exist.", "Error!");
            return string.Empty;
        }
        ...
        {
            MessageBox.Show("Error: Config.ini is corrupt.", "Error!");
            return string.Empty;
        }
